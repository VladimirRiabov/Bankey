...
//  Bankey
//
//  Created by Владимир Рябов on 07.02.2022.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    private func setup() {
        ...
        //adding and loading child view controller
        addChild(pageViewController)
        view.addSubview(pageViewController.view)
        pageViewController.didMove(toParent: self)
        
        //its says how many pages is there what is the page is now
        ...
        //we set the first page and set direction
...
//            doneButton.bottomAnchor.constraint(equalToSystemSpacingBelow: view.bottomAnchor, multiplier: 8)
